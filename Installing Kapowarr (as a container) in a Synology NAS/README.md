...
----/Kapowarr             <-- Contains all the data for the Kapowarr application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Kapowarr             <-- Contains the project for the Kapowarr application
------/compose.yaml       <-- The Kapowarr docker compose file
```
