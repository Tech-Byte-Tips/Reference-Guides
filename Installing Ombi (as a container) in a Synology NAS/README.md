...
----/Ombi                 <-- Contains all the data for the Ombi application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Ombi                 <-- Contains the project for the Ombi application
------/compose.yaml       <-- The Ombi docker compose file
```
