...
----/SearXNG                <-- Contains all the data for the SearXNG application containers
------/config               <-- Contains the configuration file
------/data                 <-- Contains the cache files
--/Projects                 <-- Contains the Container Manager projects
----/SearXNG                <-- Contains the project for the SearXNG application
------/compose.yaml         <-- The SearXNG docker compose file
```
