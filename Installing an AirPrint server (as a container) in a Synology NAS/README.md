...
----/AirPrint             <-- Contains all the data for the Pi-Hole application containers
------/config             <-- Contains the pi-hole data
------/services           <-- Contains the dnsmasq data
--/Projects               <-- Contains the Container Manager projects
----/AirPrint             <-- Contains the project for the Pi-Hole application
