...
----/AudioBookShelf       <-- Contains all the data for the AudioBookShelf application containers
------/config             <-- Contains the configuration files
------/metadata             <-- Contains the metadata files
--/Projects               <-- Contains the Container Manager projects
----/AudioBookShelf       <-- Contains the project for the AudioBookShelf application
------/compose.yaml       <-- The AudioBookShelf docker compose file
```
