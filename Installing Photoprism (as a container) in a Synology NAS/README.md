...
----/Photoprism           <-- Contains all the data for the Photoprism application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Photoprism           <-- Contains the project for the Photoprism application
------/compose.yaml       <-- The Photoprism docker compose file
```
