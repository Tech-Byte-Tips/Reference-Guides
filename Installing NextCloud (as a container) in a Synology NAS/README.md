...
----/NextCloud            <-- Contains all the data for the NextCloud application containers
------/config             <-- Contains the configuration and DB files
------/data               <-- Contains the application data (This can be in another volume)
--/Projects               <-- Contains the Container Manager projects
----/NextCloud            <-- Contains the project for the NextCloud application
------/compose.yaml       <-- The NextCloud docker compose file
```
