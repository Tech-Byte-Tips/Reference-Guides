...
----/Beeper                 <-- Contains all the data for the Beeper application containers
------/db                   <-- Contains the database files
--/Projects                 <-- Contains the Container Manager projects
----/Beeper                 <-- Contains the project for the Beeper application
------/compose.yaml         <-- The Beeper docker compose file
```
