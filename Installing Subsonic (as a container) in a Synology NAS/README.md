...
----/Subsonic             <-- Contains all the data for the Subsonic application containers
------/config             <-- Contains the configuration file and DB file
--/Projects               <-- Contains the Container Manager projects
----/Subsonic             <-- Contains the project for the Subsonic application
------/compose.yaml       <-- The Subsonic docker compose file
/HTPC                     <-- Share created to hold our media
--/Media                  <-- Folder where our media is stored
----/Music                <-- The location of our music files
----/Podcasts             <-- The location of our podcast files
```
