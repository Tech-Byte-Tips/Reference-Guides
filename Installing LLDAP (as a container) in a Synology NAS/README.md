...
----/LLDAP                <-- Contains all the data for the LLDAP application container
--/Projects               <-- Contains the Container Manager projects
----/LLDAP                <-- Contains the project for the LLDAP application
------/compose.yaml       <-- The LLDAP docker compose file
```
