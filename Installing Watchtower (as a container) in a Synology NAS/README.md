...
----/Watchtower           <-- Contains all the data for the Watchtower application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Watchtower           <-- Contains the project for the Watchtower application
------/compose.yaml       <-- The Watchtower docker compose file
```
