...
----/Frigate              <-- Contains all the data for the Actual Budget application containers
------/config             <-- Contains the configuration files
------/media              <-- Contains the camera recording files
--/Projects               <-- Contains the Container Manager projects
----/Frigate              <-- Contains the project for the Actual Budget application
