...
----/UnManic              <-- Contains all the data for the UnManic application containers
------/config             <-- Contains the configuration file and DB file
------/library            <-- Contains the media files
------/transcode          <-- This folder will be used to transcode files
--/Projects               <-- Contains the Container Manager projects
----/UnManic              <-- Contains the project for the UnManic application
------/compose.yaml       <-- The UnManic docker compose file
```
