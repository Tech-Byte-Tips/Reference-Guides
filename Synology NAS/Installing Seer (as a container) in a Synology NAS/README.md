...
----/Seer                 <-- Contains all the data for the Seer application containers
--/Projects               <-- Contains the Container Manager projects
----/Seer                 <-- Contains the project for the Seer application
------/compose.yaml       <-- The Seer docker compose file
```
