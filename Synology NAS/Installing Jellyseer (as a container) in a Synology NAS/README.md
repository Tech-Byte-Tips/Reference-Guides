...
----/Jellyseer            <-- Contains all the data for the Jellyseer application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Jellyseer            <-- Contains the project for the Jellyseer application
------/compose.yaml       <-- The Jellyseer docker compose file
```
