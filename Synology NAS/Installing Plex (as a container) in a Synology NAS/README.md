...
----/Plex                 <-- Contains all the data for the Plex application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Plex                 <-- Contains the project for the Plex application
------/compose.yaml       <-- The Plex docker compose file
```
