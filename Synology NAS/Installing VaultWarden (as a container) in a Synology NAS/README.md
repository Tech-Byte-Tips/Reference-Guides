...
----/VaultWarden          <-- Contains all the data for the VaultWarden application containers
------/data             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/VaultWarden          <-- Contains the project for the VaultWarden application
------/compose.yaml       <-- The VaultWarden docker compose file
```
