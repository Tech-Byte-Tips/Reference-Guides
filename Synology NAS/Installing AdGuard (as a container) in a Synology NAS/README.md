...
----/AdGuard                <-- Contains all the data for the AdGuard application container
------/config               <-- Contains the configuration files
--/Projects                 <-- Contains the Container Manager projects
----/AdGuard                <-- Contains the project for the AdGuard application
------/compose.yaml         <-- The AdGuard docker compose file
```
