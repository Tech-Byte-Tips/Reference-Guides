...
----/Tautulli             <-- Contains all the data for the Tautulli application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Tautulli             <-- Contains the project for the Tautulli application
------/compose.yaml       <-- The Tautulli docker compose file
```
