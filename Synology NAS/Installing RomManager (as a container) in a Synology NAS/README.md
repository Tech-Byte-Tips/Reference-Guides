...
----/RomManager           <-- Contains all the data for the RomManager application containers
------/config             <-- Contains the configuration files
------/assets             <-- Contains the configuration files
------/redis-data         <-- Contains the configuration files
------/resources          <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/RomManager           <-- Contains the project for the RomManager application
------/compose.yaml       <-- The RomManager docker compose file
```
