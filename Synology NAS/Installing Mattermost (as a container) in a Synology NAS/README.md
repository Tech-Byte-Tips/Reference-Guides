...
----/Mattermost           <-- Contains all the data for the Mattermost application containers
------/client             <-- Contains the client files
------/config             <-- Contains the config file
------/data               <-- Contains the application data
------/db                 <-- Contains the database files
------/indexes            <-- Contains the application indexes
...
----/Mattermost           <-- Contains the project for the Mattermost application
------/compose.yaml       <-- The Mattermost docker compose file
```
