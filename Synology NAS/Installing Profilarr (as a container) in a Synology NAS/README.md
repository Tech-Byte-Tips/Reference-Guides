...
----/Profilarr              <-- Contains all the data for the Profilarr application containers
------/config               <-- Contains the configuration files
--/Projects                 <-- Contains the Container Manager projects
----/Profilarr              <-- Contains the project for the Profilarr application
------/compose.yaml         <-- The Profilarr docker compose file
```
