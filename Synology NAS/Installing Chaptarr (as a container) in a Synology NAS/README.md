...
------/readarr              <-- Finished books go here
...
----/Chaptarr               <-- Contains all the data for the Chaptarr application containers
------/config               <-- Contains the configuration files
--/Projects                 <-- Contains the Container Manager projects
----/Chaptarr               <-- Contains the project for the Chaptarr application
------/compose.yaml         <-- The Chaptarr docker compose file
```
