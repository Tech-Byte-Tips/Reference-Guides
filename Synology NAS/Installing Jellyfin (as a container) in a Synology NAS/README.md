...
----/Jellyfin             <-- Contains all the data for the Jellyfin application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Jellyfin             <-- Contains the project for the Jellyfin application
------/compose.yaml       <-- The Jellyfin docker compose file
```
