...
----/Unpackerr            <-- Contains all the data for the Unpackerr application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Unpackerr            <-- Contains the project for the Unpackerr application
------/compose.yaml       <-- The Unpackerr docker compose file
```
