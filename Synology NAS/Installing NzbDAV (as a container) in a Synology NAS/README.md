...
----/NzbDAV                 <-- Contains all the data for the NzbDAV application container
------/config               <-- Contains the configuration files
--/Projects                 <-- Contains the Container Manager projects
----/NzbDAV                 <-- Contains the project for the NzbDAV application
------/compose.yaml         <-- The NzbDAV docker compose file
```
