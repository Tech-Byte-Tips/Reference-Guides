...
----/Komga                <-- Contains all the data for the Komga application containers
--/Projects               <-- Contains the Container Manager projects
----/Komga                <-- Contains the project for the Komga application
------/compose.yaml       <-- The Komga docker compose file
```
