...
----/InvoiceShelf         <-- Contains all the data for the InvoiceShelf application containers
------/config             <-- Contains the configuration file and DB file
------/data               <-- Contains the data files
--/Projects               <-- Contains the Container Manager projects
----/InvoiceShelf         <-- Contains the project for the InvoiceShelf application
------/compose.yaml       <-- The InvoiceShelf docker compose file
```
