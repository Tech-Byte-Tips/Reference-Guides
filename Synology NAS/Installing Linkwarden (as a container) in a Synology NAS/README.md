...
----/Linkwarden           <-- Contains all the data for the Linkwarden application container
------/data               <-- Contains the Linkwarden container data
------/meilisearch        <-- Contains the MeiliSearch container data
------/postgres           <-- Contains the Postgres container data
--/Projects               <-- Contains the Container Manager projects
----/Linkwarden           <-- Contains the project for the Linkwarden application
------/compose.yaml       <-- The Linkwarden docker compose file
```
