...
----/WebTrees             <-- Contains all the data for the WebTrees application container
------/app                <-- Contains the WebTrees container data
------/db                 <-- Contains the DB container data
--/Projects               <-- Contains the Container Manager projects
----/WebTrees             <-- Contains the project for the WebTrees application
------/compose.yaml       <-- The WebTrees docker compose file
```
