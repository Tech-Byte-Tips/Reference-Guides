...
----/Threadfin            <-- Contains the data for the Threadfin application
------/config             <-- Contains the Threadfin configuration
------/temp               <-- Contains temporary files
--/Projects               <-- Contains the Container Manager projects
----/Threadfin            <-- Contains the Threadfin project
------/compose.yaml       <-- The Threadfin docker compose file
```
...
1. Example M3U file: https://raw.githubusercontent.com/iptv-org/iptv/refs/heads/master/streams/us_local.m3u
2. Test Channel lists: https://epg.pw/test_channel_page.html?lang=en | https://freetv.fun/test_channels_united_states_original_new.txt
3. Test Channel XMLTV: https://epg.pw/xmltv.html?lang=en
