...
----/Linkding             <-- Contains all the data for the Linkding application containers
--/Projects               <-- Contains the Container Manager projects
----/Linkding             <-- Contains the project for the Linkding application
------/compose.yaml       <-- The Linkding docker compose file
```
