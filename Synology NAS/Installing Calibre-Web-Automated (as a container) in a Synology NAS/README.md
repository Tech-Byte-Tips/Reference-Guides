...
----/Calibre-Web-Automated  <-- Contains all the data for the Calibre-Web-Automated application containers
------/config               <-- Contains the config files
------/ingest               <-- Drop your books here for automatic processing
------/library              <-- Contains the database files and books
------/plugins              <-- Contains the application plugins
--/Projects                 <-- Contains the Container Manager projects
----/Calibre-Web-Automated  <-- Contains the project for the Calibre-Web-Automated application
------/compose.yaml         <-- The Calibre-Web-Automated docker compose file
```
