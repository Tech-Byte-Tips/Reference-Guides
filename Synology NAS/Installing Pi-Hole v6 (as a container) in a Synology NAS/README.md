...
----/Pi-Hole              <-- Contains all the data for the Pi-Hole application containers
------/pihole             <-- Contains the pi-hole data
------/dnsmasq.d          <-- Contains the dnsmasq data
--/Projects               <-- Contains the Container Manager projects
----/Pi-Hole              <-- Contains the project for the Pi-Hole application
