...
----/Subsyncarr             <-- Contains all the data for the Subsyncarr application container
--/Projects                 <-- Contains the Container Manager projects
----/Subsyncarr             <-- Contains the project for the Subsyncarr application
------/compose.yaml         <-- The Subsyncarr docker compose file
****
/HTPC                       <-- The root of our HTPC content
--/Media                    <-- The folder with the final files
----/Anime                  <-- Our anime episodes
----/Movies                 <-- Our movies
----/TV                     <-- Our tv shows
```
