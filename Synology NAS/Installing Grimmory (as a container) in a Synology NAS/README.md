...
----/Grimmory             <-- Contains all the data for the Grimmory application containers
------/books              <-- Contains your book library
------/db                 <-- Contains the MySQL database information
------/data               <-- Contains the application settings and data
------/import             <-- Is used to automatically import books to your library
--/Projects               <-- Contains the Container Manager projects
----/Grimmory             <-- Contains the project for the Grimmory application
------/compose.yaml       <-- The Grimmory docker compose file
```
