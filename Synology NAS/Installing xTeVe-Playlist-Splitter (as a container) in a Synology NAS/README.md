...
----/xTeVe-Playlist-Splitter  <-- Contains the files for the xTeVe-Playlist-Splitter application
--/Projects                   <-- Contains the Container Manager projects
------/compose.yaml           <-- The xTeVe-Playlist-Splitter docker compose file
```
...
1. LIST file: The Channel Lineup URL (in JSON format) from your IPTV provider
2. PLAYLIST file: The M3U Playlist URL from your IPTV provider

# Enjoy!

That should be it.  You should be able to just run the project and access the files created by the application.