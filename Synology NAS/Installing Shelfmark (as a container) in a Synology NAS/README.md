...
```
/HTPC                       <-- The root of our media center
--/Downloads                <-- Where the downloads are stored
----/completed              <-- Finished downloads go here
------/shelfmark            <-- Finished books go here
--/Media                    <-- The final place for our media
----/AudioBooks             <-- Audio Books go here
----/Books                  <-- Text Books go here
/docker                     <-- Share created by Container Manager
--/Containers               <-- Contains all the containers data
----/Shelfmark              <-- Contains all the data for the Shelfmark application containers
------/config               <-- Contains the configuration files
--/Projects                 <-- Contains the Container Manager projects
----/Shelfmark              <-- Contains the project for the Shelfmark application
------/compose.yaml         <-- The Shelfmark docker compose file
```
