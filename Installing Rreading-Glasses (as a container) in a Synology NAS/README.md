...
----/Rreading-Glasses       <-- Contains all the data for the Rreading-Glasses application containers
------/db                   <-- Contains the database files
--/Projects                 <-- Contains the Container Manager projects
----/Rreading-Glasses       <-- Contains the project for the Rreading-Glasses application
------/compose.yaml         <-- The Rreading-Glasses docker compose file
```
