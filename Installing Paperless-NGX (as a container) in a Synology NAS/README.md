...
----/Paperless-NGX        <-- Contains all the data for the Paperless-NGX application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Paperless-NGX        <-- Contains the project for the Paperless-NGX application
------/compose.yaml       <-- The Paperless-NGX docker compose file
```
