...
----/Whisparr             <-- Contains all the data for the Whisparr application containers
------/config             <-- Contains the configuration files
--/Projects               <-- Contains the Container Manager projects
----/Whisparr             <-- Contains the project for the Whisparr application
------/compose.yaml       <-- The Whisparr docker compose file
```
