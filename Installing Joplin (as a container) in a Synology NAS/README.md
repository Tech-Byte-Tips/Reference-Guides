...
----/Joplin                 <-- Contains all the data for the Joplin application containers
------/db                   <-- Contains the database files
--/Projects                 <-- Contains the Container Manager projects
----/Joplin                 <-- Contains the project for the Joplin application
------/compose.yaml         <-- The Joplin docker compose file
```
