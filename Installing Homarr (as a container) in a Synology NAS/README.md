...
----/Homarr                 <-- Contains all the data for the Homarr application container
--/Projects                 <-- Contains the Container Manager projects
----/Homarr                 <-- Contains the project for the Homarr application
------/compose.yaml         <-- The Homarr docker compose file
```
